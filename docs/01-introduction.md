...
- **Zero learning curve.** Create a `Double` and start testing immediately. There's no upfront decision between a mock, a spy, or a partial. Out-of-the-box a double behaves _loosely_ and automatically adjusts as you add [expectations](/expectations).
