 ...
 * (adopted as the closest, most relevant prior art — see ARCHITECTURE.md's
 * "Matcher" section). $reference only ever holds the most recently matched
 * call's value; there's no history of earlier calls.
 *
 * Capturing can't happen inside matches() — see ARCHITECTURE.md for why:
 * that method is called speculatively on every candidate expectation while
